        ...
        <div style={{ flex: 1, padding: '24px', overflowY: 'auto' }}>
          ...
          {activeTab === 'project_management' && (
            <ProjectManagementView
              ...
              setDevProjectOtpVerified={setDevProjectOtpVerified}
              devProjectOtpSent={devProjectOtpSent}
              setDevProjectOtpSent={setDevProjectOtpSent}
              devProjectOtpInput={devProjectOtpInput}
              setDevProjectOtpInput={setDevProjectOtpInput}
          ...
          {activeTab === 'lead_management' && (
            <LeadManagementView
              ...
              matchesSearchQuery={matchesSearchQuery}
              setShowLead360Drawer={setShowLead360Drawer}
              openIdDetailsModal={openIdDetailsModal}
              maskPhone={maskPhone}
              formatIndianRupees={formatIndianRupees}
              setShowCallDispositionModal={setShowCallDispositionModal}
              customers={customers}
              setSelectedCust={setSelectedCust}
              setActiveTab={setActiveTab}
              setShowTransferLeadModal={setShowTransferLeadModal}
          ...
          {activeTab === 'customer_management' && (
            <CustomerManagementView
              ...
              handleDeleteAllCurrentInside={handleDeleteAllCurrentInside}
              ...
              custStageFilter={custStageFilter}
              setCustStageFilter={setCustStageFilter}
              custSourceFilter={custSourceFilter}
              setCustSourceFilter={setCustSourceFilter}
          ...
          {activeTab === 'matching_management' && (
            <MatchingManagementView
              ...
              matchingVaultFilter={matchingVaultFilter}
              setMatchingVaultFilter={setMatchingVaultFilter}
              matchesSearchQuery={matchesSearchQuery}
              searchQuery={searchQuery}
              matchingSearchQuery={matchingSearchQuery}
              setMatchingSearchQuery={setMatchingSearchQuery}
              openIdDetailsModal={openIdDetailsModal}
              setActiveTab={setActiveTab}
              setActiveCostSheetShareSubTab={setActiveCostSheetShareSubTab}
              setSearchQuery={setSearchQuery}
              ...
              setPropertySearchQuery={setPropertySearchQuery}
          ...
          {activeTab === 'cost_sheet_share' && (
            <CostSheetSharingView
              ...
              setShowCreateShareModal={setShowCreateShareModal}
              handleDeleteAllCurrentInside={handleDeleteAllCurrentInside}
              newShareForm={newShareForm}
              setNewShareForm={setNewShareForm}
              activeCostSheetShareSubTab={activeCostSheetShareSubTab}
              setActiveCostSheetShareSubTab={setActiveCostSheetShareSubTab}
              individualCostSheets={individualCostSheets}
              setIndividualCostSheets={setIndividualCostSheets}
              formatIndianRupees={formatIndianRupees}
              individualCostSheetsSearch={individualCostSheetsSearch}
              setIndividualCostSheetsSearch={setIndividualCostSheetsSearch}
              individualCostSheetsStatusFilter={individualCostSheetsStatusFilter}
              setIndividualCostSheetsStatusFilter={setIndividualCostSheetsStatusFilter}
              matchesSearchQuery={matchesSearchQuery}
              searchQuery={searchQuery}
          ...
          {activeTab === 'visit_management' && (
            <VisitManagementView
              ...
              searchQuery={searchQuery}
              setSearchQuery={setSearchQuery}
              visitFilterStatus={visitFilterStatus}
              setVisitFilterStatus={setVisitFilterStatus}
              visitFilterDate={visitFilterDate}
              setVisitFilterDate={setVisitFilterDate}
              visitFilterExec={visitFilterExec}
              setVisitFilterExec={setVisitFilterExec}
              individualCostSheets={individualCostSheets}
              setShowScheduleVisitModal={setShowScheduleVisitModal}
              routePlannerMode={routePlannerMode}
              setRoutePlannerMode={setRoutePlannerMode}
              setShowRouteMapModal={setShowRouteMapModal}
              setShowVisitDetailModal={setShowVisitDetailModal}
              selectedVisitPlanId={selectedVisitPlanId}
              setSelectedVisitPlanId={setSelectedVisitPlanId}
              setShowIndividualStopModal={setShowIndividualStopModal}
              scheduledVisits={scheduledVisits}
              properties={properties}
              projectVisitAgreements={projectVisitAgreements}
              handleMarkVisitDoneAndNotifyDeveloper={handleMarkVisitDoneAndNotifyDeveloper}
              setShowPvaDocumentModal={setShowPvaDocumentModal}
