  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSoldProperties(soldRes.data?.data || soldRes.data || []);
      ...
      <section className="bg-gradient-to-b from-gray-900 via-navy-900 to-navy-900 text-white py-16 border-y border-gold-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 p-6 bg-navy-800/90 rounded-2xl border border-gold-500/30 text-center">
            <div>
              <div className="text-2xl sm:text-3xl font-black text-gold-400">150+</div>
              <div className="text-[11px] sm:text-xs text-gray-300 font-medium mt-1">Properties Delivered</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-black text-gold-400">₹ 250+ Cr</div>
            ...
            <div>
              <div className="text-2xl sm:text-3xl font-black text-gold-400">98%</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {newProjects.map((proj) => (
                <div key={proj._id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col sm:flex-row shadow-sm hover:shadow-navy transition-all">
